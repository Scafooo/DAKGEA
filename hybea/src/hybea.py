...
def run_hybea():
    ...
    MYPATH = cfg.BASE_DIR + "/src/hybea/experiments/" + str(round(cfg.SIZE_AFTER_REDUCTION_IN_PERCENTAGE,1)) + "/" + dataset + "_" + cfg.STRUCTURAL_MODEL + "_" + mode
    ...
    while True:
        ...
        _, ent_ids_1, ent_ids_2 = read_structure_datas(cfg.DATA_PATH, reversed=True)
        _, ent_ids_1_nrev, ent_ids_2_nrev = read_structure_datas(cfg.DATA_PATH, reversed=False)
        ...
        if turn % 2 == 0:
            ...
            for i in range(3):
                if os.path.exists(MYPATH + "/" + "rec_new_pairs_from_structure" + str(i) + ".pickle"):
                    # print("ECCOMI READ", MYPATH + "/" + "rec_new_pairs_from_structure" + str(i) + ".pickle")
            ...
            newp_attr = []
            for i in range(3):
                print(MYPATH + "/" + "rec_new_pairs_from_attr" + str(i) + ".pickle")
            ...
            print("New Pair attr len",len(newp_attr))
            print("New Pair struct len:",len(newp_struct))
            ...
            if cfg.STRUCTURAL_MODEL == "Knowformer":
                res_mat_1, res_mat_2, ents_1, ents_2, vocab, epoch_loss_list, hits_1_list = run_structure_model(
                    set(newp))
                results = reciprocity(ents_1, ents_2, res_mat_1, res_mat_2)
            ...
            elif cfg.STRUCTURAL_MODEL == "RREA":
