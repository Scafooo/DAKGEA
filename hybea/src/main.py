...
from hybea.src.attribute_model.Param import DATA_PATH
...
def main():
    ...
    MYPATH = "experiments/" + str(round(cfg.SIZE_AFTER_REDUCTION_IN_PERCENTAGE,1)) + "/" + dataset + "_" + cfg.STRUCTURAL_MODEL + "_" + mode
