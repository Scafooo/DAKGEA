...
def prepare_entity_alignment_data(args, new_pairs):
    ...
    print(s_triples_path)
    print(t_triples_path)
    print(ref_ents_path)
    print(ent_ILLs_path)
    assert os.path.exists(s_triples_path) and os.path.exists(t_triples_path) and os.path.exists(ref_ents_path) and os.path.exists(ent_ILLs_path)
    ...
    print(set(load_vocab(vocab_path)) - set(entities_list + relations_list))

    if not os.path.exists(vocab_path):
        write_vocab_path(vocab_path, entities_list, relations_list)
    else:
        print(args.vocab_size, len(load_vocab(vocab_path)))
