...
def run_t5_full_production():
    print("\n" + "█"*100); print(f"█ RTX 4090: FLAN-T5 PRODUCTION TRAINING (FULL & STRATIFIED) ".center(98) + "█"); print("█"*100)
    ...
    print("    [1/3] Building exhaustive training set...")
    t5_rows = []
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        f.write("DAKGEA FLAN-T5 FINAL PRODUCTION REPORT\n")
        f.write(f"Selection: Full KG Aligned + Stratified Orphans. Predicates: {len(report_buckets)}\n")
        f.write("="*120 + "\n\n")
    ...
    print(f"\n>>> SUCCESS: Production training completed. Report saved to {output_file}")

if __name__ == "__main__":
    run_t5_full_production()
