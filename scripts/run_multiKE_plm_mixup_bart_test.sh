...
#  forget_labels @ 10%/20%/30% + plm_mixup (bart) augmentation
...
OUTDIR="${PROJECT_ROOT}/config/experiments/generated/multiKE_plm_mixup_bart_test"
mkdir -p "${OUTDIR}"
...
SEED="11037"
SUITE="multiKE_plm_mixup_bart_test"
