#!/usr/bin/env python3
"""CLI entry point for running Data Augmentation for Knowledge Graph EA experiments."""
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Run Data Augmentation for Knowledge Graph Entity Alignment experiments.",
    )
    parser.add_argument(
        "config",
        type=Path,
