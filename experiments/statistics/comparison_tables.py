        ...
        for metric_key, _, is_percentage, decimals, higher_is_better in metrics:
            ...
            if plm_mean is None:
                ...
                if baseline_mean is not None:
                    ...
                    # Choose color: subtle green for improvement, subtle red for degradation
                    if is_improvement:
                        color_cmd = r"\cellcolor{green!15}"  # Very light green (15% opacity)
                    else:
                        color_cmd = r"\cellcolor{red!15}"    # Very light red (15% opacity)
                else:
