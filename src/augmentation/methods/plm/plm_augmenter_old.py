...
class PLMAugmenter(AugmentationMethod):
    ...
    def __init__(self, config: Optional[dict] = None):
        ...
        # Control whether to add derivedFrom predicates
    ...
    def augment(self, dataset: Dataset) -> Dataset:
        ...
        self.logger.info(
            "[PLM] Augmentation budget=%s (initial_pairs=%d, ratio=%s, max_pairs=%s, seed=%d, derived_predicate=%s)",
            budget_display,
            initial_pairs,
    ...
    def _spawn_augmented_pair(
        ...
        # Only add derivedFrom predicates if enabled
    ...
    def _clone_non_set_node(self, graph, node: URIRef) -> URIRef:
        ...
        # Only add derivedFrom predicate if enabled
        if self.add_derived_predicate:
