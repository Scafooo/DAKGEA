"""Compatibility layer for legacy HybEA scripts expecting `config.config`."""
...
# Expose runtime module to mimic the legacy interface
cfg = runtime

# Map attributes expected by old scripts directly to runtime
MODE = runtime.MODE
