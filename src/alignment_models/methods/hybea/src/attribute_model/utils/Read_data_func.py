...
def read_data(data_path):
    ...
    entity2index, ents1, ents2 = read_structure_datas(cfg.DATA_PATH)
    ents = [ent for ent in entity2index.keys()]

    
    attribute_triple_1_file_path = cfg.DATA_PATH + 'attr_triples1'
    attribute_triple_2_file_path = cfg.DATA_PATH + 'attr_triples2'
    
    att_datas_1  = read_att_data(attribute_triple_1_file_path,
                                     ents1,entity2index, cfg.DATASET, "1", add_name_as_attTriples = False)

    att_datas_2  = read_att_data(attribute_triple_2_file_path,
                                     ents2,entity2index, cfg.DATASET, "2", add_name_as_attTriples = False)
    attr_types_1 = {}
    i = 0
