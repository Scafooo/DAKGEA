...
def _read_data(
    ...
    logger.verbose("[BERT-INT DEBUG] Total entities loaded: %d", len(index2entity))
    ...
    logger.verbose("[BERT-INT DEBUG] KG1 entities: %d, KG2 entities: %d", len(ent_ids_1), len(ent_ids_2))
